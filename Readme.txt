...
Datei in Eclipse öffnen (in unserem Testbeispiel wurde Eclipse Oxygen genutzt, Kompatibilität mit älteren Versionen ist nicht garantiert):
...
Um die Bibliotheken hinzuzufügen, einfach in Eclipse per Rechtsklick unter BuildPath -> Configure Build Path den Reiter Libraries auswählen und über "Add External JARs" die SQLite und Gson Dateien hinzufügen.

JUnit 5 ist in Eclipse schon vorhanden, muss aber auch über den Build Path in das Projekt geladen werden.
...
Nachdem der Server gestartet wurde (Statusmeldung: "Server gestartet" in der Konsole) kann die App in AndroidStudio gestartet werden und die Verbindung wird aufgebaut.
...
"Src" enthält den Quelltext für die App, in drei weiteren Unterordnern.
...
Beim ersten Start von Android Studio kann man am besten unter "Open existing project" das Projekt auswählen.
...
Die Funktionsweise der App ist in der Datei App_Guide.txt näher beschrieben.
